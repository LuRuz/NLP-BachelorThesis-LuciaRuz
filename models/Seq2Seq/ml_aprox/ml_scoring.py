...
path_predictions='./ml_aprox/summaries/'+nameDataset+'.csv'
if not os.path.exists(path_predictions):
    ...
    gcc.download_blob(BUCKET_NAME,'tfg/summaries/machine-learning/'+nameDataset+'.csv',path_predictions)
else:
...
path_scores='./ml_aprox/evaluation/'+nameDataset+'.txt'
...
gcc.upload_blob(BUCKET_NAME,path_scores,'tfg/scores/machine-learning/'+nameDataset+'-score.txt' )
